...
function DestinationDetailPage() {
    ...
    const getRestaurantDetails = () => {
        ...
        setLoading(true);
        axios.get(`/GetDestinationDetails/${locationId}`, dataConfig)
            .then(response => {
            ...
            <Grid container component="main">
                <Grid item xs={12} sm={12} md={12}>
                    <Breadcrumbs aria-label="breadcrumb" sx={{ marginTop: 1, marginLeft: 3 }}>
                        ...
                        <Typography color="inherit" sx={{ textDecoration: 'underline' }}><i>Destinasyonlar</i></Typography>
                ...
                <Grid container>
                    ...
                    <Grid item xs={12} sm={12} md={7} sx={{ marginTop: 3, marginBottom: 5 }}>
                        ...
                        <Rating name="rating" value={4} precision={0.5} readOnly />
                    </Grid>
                    ...
                    <Grid item xs={12} sm={12} md={3}>
                        <CardContent className={classes.contactInfo}>
                            ...
                            <ListItem>
                                ...
                                <ListItemText primary={<b>Telefon:</b>} secondary={restaurantGeneralData.PHONE ? restaurantGeneralData.PHONE : '-'} />
                            </ListItem>
                            <ListItem>
                                <ListItemIcon>
                                    <EmailIcon />
